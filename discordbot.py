...
async def on_message(message):
    ...
    if re.search("好奇心王国はどんな未来像を描いているの？", message.content):
        await message.channel.send('ロロたんは  誰かのふとした思いつきと行動が\nオセロのように世の中をひっくり返すと\n信じているロロ。\nそして、その原動力は好奇心だと思うロロ。\n\n今は、たくさんお金のある人が暮らしやすい\n世の中になっているけど、たくさんの\n好奇心のある人達が暮らしやすくなるような\n”好奇心資本主義”とも呼ぶべき世の中を\nつくっていきたいロロ〜')

    if re.search("ロロたん一緒に遊ぼう", message.content): #もし、こんにちはを含むメッセージで、
